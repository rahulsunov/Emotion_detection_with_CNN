...
json_file = open('/Users/rahulsunov/Desktop/Jcomp/Emotion_detection_with_CNN-main/model/emotion_model.json', 'r')
loaded_model_json = json_file.read()
json_file.close()
emotion_model = model_from_json(loaded_model_json)

# load weights into new model
emotion_model.load_weights("/Users/rahulsunov/Desktop/Jcomp/Emotion_detection_with_CNN-main/model/emotion_model.h5")
...
while frames > 0:
    ...
    if not ret:
        break
    face_detector = cv2.CascadeClassifier('/Users/rahulsunov/Desktop/Jcomp/Emotion_detection_with_CNN-main/haarcascades/haarcascade_frontalface_default.xml')
...
movies_data = pd.read_csv('/Users/rahulsunov/Desktop/Jcomp/Emotion_detection_with_CNN-main/data/movies_metadata.csv')
